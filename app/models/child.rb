class Child < ApplicationRecord
  belongs_to :church
  belongs_to :president, class_name: "App::Faithful", foreign_key: "president_id", required: false
  ...
  belongs_to :manager, class_name: "App::Faithful", foreign_key: "manager_id", required: false
